...
object LyraIcons {
    ...
    val HelpOutline: ImageVector by lazy {
        lyraIcon(
            name = "HelpOutline",
            pathData = "M11,18h2v-2h-2v2zM12,2C6.48,2 2,6.48 2,12s4.48,10 10,10 10,-4.48 10,-10S17.52,2 12,2z" +
    ...
    val Delete: ImageVector by lazy {
        lyraIcon(
            name = "Delete",
            pathData = "M6,19c0,1.1 0.9,2 2,2h8c1.1,0 2,-0.9 2,-2V7H6v12zM19,4h-3.5l-1,-1h-5l-1,1H5v2h14V4z",
        )
    }
    ...
    val Refresh: ImageVector by lazy {
        lyraIcon(
            name = "Refresh",
            pathData = "M17.65,6.35C16.2,4.9 14.21,4 12,4c-4.42,0 -7.99,3.58 -7.99,8s3.57,8 7.99,8" +
                    "c3.73,0 6.84,-2.55 7.73,-6h-2.08c-0.82,2.33 -3.04,4 -5.65,4c-3.31,0 -6,-2.69 -6,-6" +
    ...
    val Clock: ImageVector by lazy {
        lyraIcon(
            ...
            pathData = "M11.99,2C6.47,2 2,6.48 2,12s4.47,10 9.99,10C17.52,22 22,17.52 22,12S17.52,2 11.99,2z" +
                    ...
                    "M12.5,7H11v6l5.25,3.15 0.75,-1.23 -4.5,-2.67V7z",
        )
    }
}
